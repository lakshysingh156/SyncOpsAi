      ...
      <table className="w-full">
        ...
        <tbody>
          {services.map((service) => (
            <tr
              key={service.id}
              className="border-b border-border bg-surface hover:bg-surface-2 transition-colors"
            >
              ...
              <td className="px-4 py-3">
                <span
                  className={cn(
                    ...
                    tierColors[service.tier as keyof typeof tierColors] || tierColors.normal
                  )}
                >
                  {service.tier}
                </span>
              ...
              <td className="px-4 py-3 text-right">
                <div className="flex justify-end gap-2">
                  <button
                    ...
                    className="p-1.5 text-muted hover:text-accent transition-colors rounded hover:bg-surface-2"
                    title="Edit service"
                  >
                  ...
                  <button
                    ...
                    className="p-1.5 text-muted hover:text-danger transition-colors rounded hover:bg-surface-2"
